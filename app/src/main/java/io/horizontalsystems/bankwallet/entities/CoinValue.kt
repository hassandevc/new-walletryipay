...
data class CoinValue(
    ...
    sealed class Kind {
        ...
        abstract val coin: io.horizontalsystems.marketkit2.models.Coin

        data class PlatformCoin(val platformCoin: io.horizontalsystems.marketkit2.models.PlatformCoin) : Kind() {
            override val decimal: Int
                get() = platformCoin.platform.decimals
            override val coin: io.horizontalsystems.marketkit2.models.Coin
                get() = platformCoin.coin
        }

        data class Coin(override val coin: io.horizontalsystems.marketkit2.models.Coin, override val decimal: Int) : Kind()
    }
